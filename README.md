...
**заметка**: в cos.py к некоторым строчкам остались лишние комментарии, частично связано с тем, что код расчета кос.близости я где-то находила (не могу найти источник, но оставлю на него ссылку в ридми, как найду)
